...
customer.add_to_cart(food_item3, -2)  # Set breakpoint here to check the error

delivery_service = DeliveryService()
delivery_service.add_restaurant(restaurant1)
delivery_service.add_restaurant(restaurant2)

restaurant1.remove_from_menu(food_item2, 6)  # Set breakpoint here to check the error

restaurant2.remove_from_menu(food_item1, 1)  # Set breakpoint here to check the error
