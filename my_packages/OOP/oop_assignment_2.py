"""
    ...
    Create a class for a BankAccount, and another for Customer. T
"""
...
class BankAccount:
    ...
    def __del__(self):
        print(
            f"Bank account {self.account_number} of type \
            {self.account_type} is being deleted.")
...
# Deleting the customer object will also trigger
# the deletion of the associated bank account object.
del customer1
